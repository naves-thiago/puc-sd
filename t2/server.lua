...
local function parse_incoming(incoming, idl)
    ...
    local methinfo = idl.interfaces.methods[name]
...
function m.register_servant(idlname, o)
	idls = {}
	current_idl = idlname
    idls[idlname] = {}
	idls[idlname].interfaces = {}
	...
	function _ENV.interface(t)
		...
		idls[current_idl].interfaces.methods = t.methods
	end
	...
	for name, func in pairs(o) do
		idl.interfaces.methods[name].func = func
	end
